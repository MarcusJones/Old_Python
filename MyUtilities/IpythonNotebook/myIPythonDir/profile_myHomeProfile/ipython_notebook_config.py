...
#cmdList.append("from exergyframes import exergy_frame as xrg")
...
c.InteractiveShellApp.exec_lines = cmdList
#------------------------------------------------------------------------------
...
# variable IPYTHONDIR.
# c.NotebookApp.ipython_dir = u'D:\\Users\\Anonymous\\.ipython'
...
# $HOME/.ipython. This options can also be specified through the environment
# variable IPYTHONDIR.
# c.IPKernelApp.ipython_dir = u'D:\\Users\\Anonymous\\.ipython'
...
#c.IPKernelApp.exec_files = [r"D:\EclipseSpace2\MyUtilities\IpythonNotebook\myIPythonDir\profile_myHomeProfile\myImportStartup.py"]
...
# c.NotebookManager.notebook_dir = u'D:\\Windows\\system32'
