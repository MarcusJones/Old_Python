...
class TRNSYS_Parser:
    def __init__(self,name,attribList = [0,1],targetFile=''):
        self.inputFile = open('..\\Test DCK files\\test.dck', 'r')
        self.outputFile = open('..\\XML Output\\test.xml', 'w')
        keywordDictionary = {
    ...
    def foundKeyword(self, keywordDictionary, word):
    ...
    def CONSTANTS    (lines, lineIndex, currentXML): 
        ...
        while 1 :
            ...
            elif (foundKeyword(keywordDictionary, words[0])):
...
#    k = foundKeyword(keywordDictionary, words[0])
#    if k: 
