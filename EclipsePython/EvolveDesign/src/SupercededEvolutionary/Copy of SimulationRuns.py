...
#    
    def __init__(   self,
        ...
        logging.info("Creating a SimulationRun over {0}".format(self.variableVector))

        #logging.info("Disabled variableNameList, variableValueList".format(self.variableVector))
...
#        
        ...
        #logging.info("Created a SimulationRun, had to modify...".format(self))
    ...
    def translateInputFiles(self): 
        ...
        for inputFileObject in self.inputTemplateFileObjects:
            ...
            for variable in self.variableVector:
                ...
                matches = re.findall(variable.regexTarget, inputFileObject.fileData)
                #print re.sub(variable.regexTarget, str(variable.value), inputFileObject.fileData)
                inputFileObject.fileData = re.sub(variable.regexTarget, str(variable.value), inputFileObject.fileData)
...
class TrnsysRun(SimulationRun):
    ...
    def createProject(self):
        ...
        self.inputTemplateFileObjects[1].outputFilePath = self.DCK_filePath
